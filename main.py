...
def run_sma_crossover_backtest(
    ...
    # yfinance 버전 업데이트 대응: MultiIndex 및 DataFrame 형태 평탄화
    df = df[["Close"]].copy()
...
def calculate_performance_metrics(
    ...
    # 연율화 전략 수익률 및 변동성 (로그 수익률의 연속성 활용)
...
if __name__ == "__main__":
    ...
    # 1. 백테스트 실행 (50일/200일 골든크로스/데드크로스)
    data = run_sma_crossover_backtest(
        TICKER, START, END, short_window=50, long_window=200
    )
